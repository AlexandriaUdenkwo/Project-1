...
int main(){
    ...
    double thetaiv = 85.0*(M_PI/180.0);
    ...
    int pointsx = 960;//512;//64;//960;//1920; //64*1;
    int pointsy = 540;//288;//36;//540;//1080; //36*1;
    ...
    std::ofstream output_file("output_blackhole_high_res.csv");
